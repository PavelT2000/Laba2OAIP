...
//  begin
//    MediaPlayers[i] := TMediaPlayer.Create(Main.OurForm );
//    MediaPlayers[i].Parent := Main.OurForm;
...
begin
  try
    ...
    OurForm.MediaPlayer1.FileName := MusicLocation[music];
    OurForm.MediaPlayer1.Open;
    OurForm.MediaPlayer1.Play;
